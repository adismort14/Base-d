...
const Sign = () => {
  return (
    <div className="bg-[#F8FAFF] w-[1440px] h-[1024px] flex">
      <div className="w-1/2 h-[1024px] flex relative">
        {/*left half*/}
        {/* SVG */}
        <svg
        ...
        <svg
          ...
          viewBox="0 0 81 81"
          fill=""
          className="absolute top-[54.32px] left-[61.03px]"
        >
        ...
        <svg
          ...
          viewBox="0 0 87 30"
          fill="none"
          className="absolute top-[83.71px] left-[59.03px]"
        >
          <path
        ...
        {/* Text */}
        <div className="absolute left-[196px] bottom-1/2 text-white font-montserrat text-[72px] not-italic font-bold">
          BASE
        </div>
        {/* Logos */}
        <div class="flex bottom-[67px] left-[144.5px] w-[299px] justify-between items-center absolute">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="45"
            height="44"
      ...
      <div className="w-1/2 h-[1024px] flex relative">
        ...
        <div className="text-black font-montserrat text-[36px] absolute top-[235px] right-[483.01px] font-bold ">
          Sign In
        </div>
        <div className="text-black font-lato text-[16px] absolute top-[289.11px] right-[450.08px] font-normal">
          Sign in to your account
        </div>
        <button className="absolute top-[338.51px] right-[429.22px] cursor-pointer flex [border:none] pt-[0.56rem] pb-[0.44rem] pr-[1.31rem] pl-[1.25rem]">
          <div className="h-full w-full absolute my-0 mx-[!important] top-[-0.06rem] right-[0.01rem] bottom-[0.13rem] left-[0.01rem] z-[1]">
            <div className="absolute h-full w-full top-[0rem] right-[0rem] bottom-[0rem] left-[0rem] rounded-[10px] bg-white" />
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            ...
            viewBox="0 0 16 16"
            fill="none"
            className="h-[0.96rem] w-[0.96rem] relative overflow-hidden shrink-0 object-cover z-[2]"
          >
        ...
        <button className="absolute top-[338.51px] right-[204.18px] cursor-pointer flex [border:none] pt-[0.56rem] pb-[0.44rem] pr-[1.31rem] pl-[1.25rem]">
          <div className="h-full w-full absolute my-0 mx-[!important] top-[-0.06rem] right-[0.01rem] bottom-[0.13rem] left-[0.01rem] z-[1]">
            <div className="absolute h-full w-full top-[0rem] right-[0rem] bottom-[0rem] left-[0rem] rounded-[10px] bg-white" />
          </div>
          <svg
        ...
        <div className="absolute top-[398.88px] right-[204.18px] shrink-0 bg-white w-[422.635px] h-[347.988px] rounded-[20px] p-[32.93px]">
          <div className="relative font-lato text-base font-normal text-black">
            Email Address
          </div>
          <input
            className="relative rounded-[10px] px-4 bg-[#F5F5F5] mt-[10.98px] w-[356.77px] h-[43.91px] [border:none] [outline:none] inline-block whitespace-nowrap z-[3]"
            placeholder="adityasa@iitbhilai.ac.in"
            type="text"
          ></input>
          <div className="relative font-lato text-base font-normal text-black mt-[21.96px]">
            Password
          </div>
          <input
            className="relative rounded-[10px] px-4 bg-[#F5F5F5] mt-[10.98px] w-[356.77px] h-[43.91px] [border:none] [outline:none] inline-block whitespace-nowrap z-[3]"
        ...
        <div className="absolute top-[768px] right-[272.24px] font-lato">
          ...
          <span className="text-[#346BD4] ml-1">Register here</span>
        </div>
      </div>
    </div>
  );
